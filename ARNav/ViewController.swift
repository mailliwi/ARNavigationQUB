...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    // TO DELETE. Irrelevant and cannot be seen.
    ...
    override func viewDidLoad() {
        ...
        // show debug options
        // to turn off or comment out when done with manuel testing
        // just serves to show there is proper scene tracking
        ...
        // TODO: Enable AR Occlusion
        // NOTE: ATM, not functional, commenting out
        // turn on AR occlusion
        // check if device can allow for this feature (Apple A12 chip or newer only). App will stop if not supported
        // then enable people occlusion
        /*
        guard let config = sceneView.session.config as? ARWorldTrackingConfiguration.supportsFrameSemantics(.personSegmentationWithDepth) else {
