...
class ViewController: UIViewController, ARSCNViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // allows the updating of the user's current speed but also makes mapViewController crash
        // If the user's speed is not great enough, it will show negative result like "-1"
        // leave code commented out to not crash the mapViewController
